<template>
  <div id="app" class="flex container h-screen w-full">
    ...
    <div class="lg:w-1/5 border-r border-lighter px-2 lg:px-6 py-2 flex flex-col justify-between">
      <div>
        <!-- Change this to Amerix Logo -->
        <button class="h-12 w-12 hover:bg-lightblue text-3xl rounded-full text-blue">
          <!-- <i class="fab fa-twitter"></i> -->
          <img src="logo.png" class="rounded-full border border-lighter" />
        </button>
      ...
      <div class="lg:w-full relative">
        <button @click="dropdown = true" class="flex items-center w-full hover:bg-lightblue rounded-full p-2 focus:outline-none">
          ...
          <div class="hidden lg:block ml-4">
            <p class="text-sm font-bold leading-tight"> Evans Ogego </p>
            <p class="text-sm leading-tight"> @CodeArtist254 </p>
          </div>
        ...
        <div v-for="tweet in tweets" class="w-full p-4 border-b hover:bg-lighter flex">
          ...
          <div class="w-full">
            <div class="flex items-center w-full">
              <p class="font-semibold"> Evans Ogego </p>
              <p class="text-sm text-dark ml-2"> @CodeArtist254 </p>
  ...
  data() {
    return {
      tabs: [
        ...
        {icon: 'fas fa-clipboard-list', title: 'Spaces', id: 'lists'},
      ...
      dropdown: false,
      trending: [
        {top: 'Trending in Kenya', title: 'Evans Monari', bottom: 'Trending with: Rip Evans Monari'},
